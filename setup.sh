...
function InstallDependenciesPacman
{
	...
	dep="gcc g++ make cmake sdl2 sdl2_image sdl_sound glew openal assimp"
...
function InstallDependenciesAptGet
{
	...
	dep="build-essential cmake libsdl2-image-dev libsdl-sound1.2-dev libsdl2-dev libglew-dev libopenal-dev libassimp-dev"
...
function InstallDependenciesDnf
{
	...
	dep="gcc gcc-c++ make cmake SDL2_image-devel SDL2-devel SDL_sound-devel glew-devel openal-devel assimp-devel"
...
function InstallDependenciesDarwin
{
	...
	dep_apple="cmake sdl2 sdl2_image sdl_sound glew openal assimp"
...
{
	pkg install sdl2 sdl2_image sdl_sound openal-soft glew assimp
}
