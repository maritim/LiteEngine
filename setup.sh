...
function InstallDependenciesPacman
{
	...
	dep="gcc g++ make cmake sdl2 sdl2_image glew assimp"
...
function InstallDependenciesAptGet
{
	...
	dep="build-essential cmake libsdl2-image-dev libsdl2-dev libglew-dev libassimp-dev"
...
function InstallDependenciesDnf
{
	...
	dep="gcc gcc-c++ make cmake SDL2_image-devel SDL2-devel glew-devel assimp-devel"
...
function InstallDependenciesDarwin
{
	...
	dep_apple="cmake sdl2 sdl2_image glew assimp"
