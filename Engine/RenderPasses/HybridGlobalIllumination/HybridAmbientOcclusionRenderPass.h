#ifndef HYBRIDAMBIENTOCCLUSIONRENDERPASS_H
#define HYBRIDAMBIENTOCCLUSIONRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API HybridAmbientOcclusionRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(HybridAmbientOcclusionRenderPass)
