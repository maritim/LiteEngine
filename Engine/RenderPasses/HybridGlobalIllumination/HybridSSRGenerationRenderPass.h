#ifndef HYBRIDSSRGENERATIONRENDERPASS_H
#define HYBRIDSSRGENERATIONRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API HybridSSRGenerationRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(HybridSSRGenerationRenderPass)
