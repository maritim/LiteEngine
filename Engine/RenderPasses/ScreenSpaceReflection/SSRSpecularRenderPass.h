#ifndef SSRSPECULARRENDERPASS_H
#define SSRSPECULARRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API SSRSpecularRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(SSRSpecularRenderPass)
