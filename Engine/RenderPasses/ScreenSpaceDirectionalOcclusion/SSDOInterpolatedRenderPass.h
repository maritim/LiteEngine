#ifndef SSDOINTERPOLATEDRENDERPASS_H
#define SSDOINTERPOLATEDRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API SSDOInterpolatedRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(SSDOInterpolatedRenderPass)
