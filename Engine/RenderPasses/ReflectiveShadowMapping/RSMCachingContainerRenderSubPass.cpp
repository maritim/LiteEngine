#include "RSMCachingContainerRenderSubPass.h"
...
RSMCachingContainerRenderSubPass::RSMCachingContainerRenderSubPass () :
...
void RSMCachingContainerRenderSubPass::Init (const RenderSettings& settings)
{
	/*
...
void RSMCachingContainerRenderSubPass::Clear ()
{
	/*
...
bool RSMCachingContainerRenderSubPass::IsAvailable (const RenderScene* renderScene, const Camera* camera,
...
RenderVolumeCollection* RSMCachingContainerRenderSubPass::Execute (const RenderScene* renderScene, const Camera* camera,
...
void RSMCachingContainerRenderSubPass::StartPostProcessPass ()
{
	/*
...
void RSMCachingContainerRenderSubPass::PostProcessPass (const RenderScene* renderScene, const Camera* camera,
	const RenderSettings& settings, RenderVolumeCollection* rvc)
{
	/*
	 * Set viewport
...
void RSMCachingContainerRenderSubPass::EndPostProcessPass ()
{
	/*
...
void RSMCachingContainerRenderSubPass::UpdateRSMCachingSettings (const RenderSettings& settings)
{
...
std::vector<PipelineAttribute> RSMCachingContainerRenderSubPass::GetCustomAttributes (const RenderSettings& settings, RenderVolumeCollection* rvc)
{
	/*
...
void RSMCachingContainerRenderSubPass::ReinitRSMCacheVolume (const RenderSettings& settings)
{
	/*
