#ifndef RSMCACHINGRENDERPASS_H
#define RSMCACHINGRENDERPASS_H
...
class RSMCachingRenderPass : public ContainerRenderSubPassI
{
	DECLARE_RENDER_PASS(RSMCachingRenderPass)
...
public:
	RSMCachingRenderPass ();
	virtual ~RSMCachingRenderPass ();
