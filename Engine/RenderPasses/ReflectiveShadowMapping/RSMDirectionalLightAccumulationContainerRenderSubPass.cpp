#include "RSMDirectionalLightAccumulationContainerRenderSubPass.h"
...
RSMDirectionalLightAccumulationContainerRenderSubPass::RSMDirectionalLightAccumulationContainerRenderSubPass () :
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::Init (const RenderSettings& settings)
{
	/*
...
RenderVolumeCollection* RSMDirectionalLightAccumulationContainerRenderSubPass::Execute (const RenderScene* renderScene, const Camera* camera,
...
bool RSMDirectionalLightAccumulationContainerRenderSubPass::IsAvailable (const RenderLightObject* renderLightObject) const
{
	/*
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::Clear ()
{
	_reflectiveShadowMapVolume->Clear ();
}

void RSMDirectionalLightAccumulationContainerRenderSubPass::StartShadowMapPass ()
{
	/*
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::ShadowMapGeometryPass (const RenderScene* renderScene, const Camera* lightCamera,
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::EndShadowMapPass ()
{
	_reflectiveShadowMapVolume->EndDrawing ();
}

Camera* RSMDirectionalLightAccumulationContainerRenderSubPass::GetLightCamera (const RenderScene* renderScene, const Camera* viewCamera)
{
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::LockShader (int sceneLayers)
{
	/*
	 * Unlock last shader
	*/
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::InitRSMVolume (const RenderSettings& settings)
{
...
void RSMDirectionalLightAccumulationContainerRenderSubPass::UpdateRSMVolume (const RenderSettings& settings)
{
