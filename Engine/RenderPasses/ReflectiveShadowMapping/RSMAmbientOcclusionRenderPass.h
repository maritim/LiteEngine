#ifndef RSMAMBIENTOCCLUSIONRENDERPASS_H
#define RSMAMBIENTOCCLUSIONRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API RSMAmbientOcclusionRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(RSMAmbientOcclusionRenderPass)
