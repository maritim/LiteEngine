#ifndef VCTSUBSURFACESCATTERINGRENDERPASS_H
#define VCTSUBSURFACESCATTERINGRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API VCTSubsurfaceScatteringRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(VCTSubsurfaceScatteringRenderPass)
