#ifndef BLOOMACCUMULATIONRENDERPASS_H
#define BLOOMACCUMULATIONRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API BloomAccumulationRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(BloomAccumulationRenderPass)
