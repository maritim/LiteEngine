...
void DirectionalLightShadowMapRenderPass::Notify (Object* sender, const SettingsObserverArgs& args)
{
...
void DirectionalLightShadowMapRenderPass::UpdateCascadeLevelsLimits (const Camera* camera)
{
	/*
...
void DirectionalLightShadowMapRenderPass::InitSettings ()
{
	/*
...
void DirectionalLightShadowMapRenderPass::ClearSettings ()
{
	/*
	 * Detach
	*/
...
void DirectionalLightShadowMapRenderPass::InitShadowMapVolume ()
{
	/*
	 * Initialize shadow map volume
	*/
