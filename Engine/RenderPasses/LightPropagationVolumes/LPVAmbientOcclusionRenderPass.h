#ifndef LPVAMBIENTOCCLUSIONRENDERPASS_H
#define LPVAMBIENTOCCLUSIONRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API LPVAmbientOcclusionRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(LPVAmbientOcclusionRenderPass)
