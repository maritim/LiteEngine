#ifndef SSRACCUMULATIONRENDERPASS_H
#define SSRACCUMULATIONRENDERPASS_H

#include "RenderPasses/PostProcess/PostProcessRenderPass.h"

class ENGINE_API SSRAccumulationRenderPass : public PostProcessRenderPass
{
	DECLARE_RENDER_PASS(SSRAccumulationRenderPass)
